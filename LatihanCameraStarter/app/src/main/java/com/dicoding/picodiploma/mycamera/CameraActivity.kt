...
class CameraActivity : AppCompatActivity() {
    ...
    private fun startCamera() {
        // showCamera
        val cameraProviderFuturee = ProcessCameraProvider.getInstance(this)

        cameraProviderFuturee.addListener({
            val cameraProvider: ProcessCameraProvider = cameraProviderFuturee.get()
